    ...
    <div>
      {selectedChat && (
        <div className="flex flex-col">
          <div className="flex text-white w-full h-12 items-center gap-3">
            <img
          ...
          {loading ? (
            ...
            <>
              <div
                ...
                className="flex flex-col gap-4 my-4 h-[400px] overflow-y-auto border border-gray-300 rounded-2xl bg-gray-100 p-3"
              >
                {messages &&
                  messages.map((e) => (
                    <Message
